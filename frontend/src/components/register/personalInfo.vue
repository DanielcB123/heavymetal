<template>
    <div class="w-5/6 sm:w-1/3 mt-8 -ml-12 sm:ml-0">
        <div class="w-full bg-white rounded-sm shadow-2xl p-8 m-4">
            ...
            <form @submit.prevent="register" class="w-full h-4/6 bg-white mt-12">
                <div class="flex flex-col mb-4">
                    ...
                    <input class="border py-2 px-3 text-grey-800" type="text" placeholder="First Name" id="firstName" v-model="form.firstName"><br/>
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="last_name">Last Name</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" placeholder="Last Name" id="lastName" v-model="form.lastName">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="email">Email</label>
                    <input class="border py-2 px-3 text-grey-800" type="email" placeholder="Email" id="email" v-model="form.email">
                </div>
                <!-- <div class="flex flex-col mb-4">
